  ...
  protected function getHeaderActions(): array
  {
    return [
      ...
      Actions\DeleteAction::make()
        ...
        ->modalDescription('Apakah Anda yakin ingin menghapus data izin ini?')
    ...
    return $infolist
      ->schema([
        Infolists\Components\Section::make('Informasi Izin')
          ->schema([
            Infolists\Components\TextEntry::make('izin_id')
              ->label('ID Izin')
              ->badge()
              ->color('primary'),
            ...
            Infolists\Components\TextEntry::make('status_izin')
              ->label('Status Izin')
              ->badge()
        ...
        Infolists\Components\Section::make('Informasi Persetujuan')
          ->schema([
            ...
            Infolists\Components\TextEntry::make('alasan_penolakan')
              ...
              ->prose()
              ->visible(fn($record) => $record->status_izin === 'Ditolak'),
          ])
          ->columns(2)
          ->visible(fn($record) => in_array($record->status_izin, ['Disetujui', 'Ditolak'])),
